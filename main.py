...
# 1- subdomains and title and status code of each subdomain 
...
# 2- subdomains and their ips and open ports
...
# 3- found emails and phone number 
...
# 4- whois look up to check domain information
